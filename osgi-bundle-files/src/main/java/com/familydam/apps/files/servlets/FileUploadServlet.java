 ...
 */
@SlingServlet(
        paths = {"/api/familydam/v1/files/upload"}, metatype = true
)
@Properties({
    ...
    protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException
    {
       String resourcePath = request.getRequestPathInfo().getResourcePath();
        ...
        try {
            ...
            if (isMultipart) {
                final Map<String, org.apache.sling.api.request.RequestParameter[]> partMap = request.getRequestParameterMap();
                String _uploadPath = null;
                String _fileName = null;
                String _path = null;
                Map<String, Object> _props = new HashMap<>();

                for (final Map.Entry<String, org.apache.sling.api.request.RequestParameter[]> pairs : partMap.entrySet()) {
...
//                            }
                            ...
                            _newFile.setProperty(FamilyDAMCoreConstants.DAM_DATECREATED, dateFormat.format(dateStamp.getTime()));
