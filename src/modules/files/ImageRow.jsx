...
module.exports = React.createClass({
    ...
    render: function () {
        ...
        return (
            <TableRow key={this.state.file.path}>
                <TableRowColumn>
                    <img src={this.state.file._links.thumb} style={{'width':'50px', 'height':'50px'}}/>
                    {this.state.file.name}
                </TableRowColumn>
                <TableRowColumn>---</TableRowColumn>
                <TableRowColumn>{this.state.file['jcr:created']}</TableRowColumn>
                <TableRowColumn>
                    <LinkContainer to="photos/details" query={{'path':this.state.file.path}}>
                        <IconButton iconClassName="material-icons">launch</IconButton>
                    </LinkContainer>
                    ...
                    <IconButton iconClassName="material-icons"
                                ...
                                data-path={this.props.file._links.delete}>delete</IconButton>

                    <IconButton iconClassName="material-icons"
                                onClick={this.handleDownloadOriginal}
                                data-path={this.props.file._links.download}>file_download</IconButton>
                </TableRowColumn>
            </TableRow>
        );
    },
            ...
            <div className="container-fluid" style={{'display': 'table-cell', 'width':'100%'}}>
                <div className="row">
                    <div className="col-sm-6 col-lg-7" style={{'overflow':'hidden'}}>
                        <LinkContainer to="photos/details"
                                       query={{'path':this.state.file.path}}><label>{this.state.file.name}</label></LinkContainer>
                    </div>
                                ...
                                <ButtonGroup bsSize="small" style={{'verticalAlign':'middle'}}>
                                    ...
                                    {(() => {
                                        if (this.props.file._links !== undefined && this.props.file._links.download !== undefined)
                                        {
                                            ...
                                            return (
                                                <Button onClick={this.handleDownloadOriginal}
