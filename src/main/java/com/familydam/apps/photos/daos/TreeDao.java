...
import com.familydam.apps.photos.servlets.ListDatesServlet;
...
public class TreeDao
{
     ...
     */
    public Map dateTree(Session session) throws RepositoryException
    {
...
//
     ...
     * @throws RepositoryException
     */
    public List<Map> tagList(Session session) throws RepositoryException
    {
     ...
     * @throws RepositoryException
     */
    public List<Map> peopleList(Session session) throws RepositoryException
    {
