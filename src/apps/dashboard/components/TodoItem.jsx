                    ...
                    <div className="edit">
                        <div class="row">
                            <div class="large-12 columns">
                                <input ref="editInput" valueLink={this.linkState('editValue')} onKeyUp={this.handleValueChange} onBlur={this.handleBlur} />
                            </div>
                            <div class="large-12 columns">
                                <input ref="editUrlInput" valueLink={this.linkState('editUrlValue')} onKeyUp={this.handleValueChange} onBlur={this.handleBlur} />
                            </div>
                        </div>
                    </div>
                </li>
